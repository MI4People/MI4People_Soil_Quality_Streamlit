...
def show_predict_page():
    ...
    if ok:
        ...
        #acount maria
        config.instance_id = 'da6f7f36-dd9f-4221-ba61-32f50df84c93'
        config.sh_client_id = '10761e65-0d01-4672-83a9-6cd5f5079e80'
        config.sh_client_secret = 'tk?v.KF|N2WrAA^WZfD>Vk0acl)!FG@y|o]#dq6N'
        config.save()

...
def show_predict_page():
    ...
    if ok:
        ...
        #acount maria
        config.instance_id = '30ac728f-79dc-4ea2-8adf-0f2c2a90c987'
        config.sh_client_id = '3cff915a-d93b-4f56-8dad-c6002a7676a6'
        config.sh_client_secret = 'A.znL7|h;+lZ5%e]vSC-E8,i1|4S-&,XK94q*xIq'
        config.save()

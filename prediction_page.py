...
def show_predict_page():
    ...
    if ok:
        ...
        #acount maria
        config.instance_id = 'cac81358-f1af-48b2-a5d6-32ca4f51b1bb'
        config.sh_client_id = '03d78215-9eab-4bdf-9695-4780b875e154'
        config.sh_client_secret = 'EtPMoT(K?C[~)Z?FG20Uedw<>{p9T5+}<FD)z#F|'
        config.save()

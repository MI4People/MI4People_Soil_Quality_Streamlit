...
def show_predict_page():
    ...
    if ok:
        ...
        #acount maria
        config.instance_id = 'e12ba1ce-d463-46c6-b138-2c205aeeebdd'
        config.sh_client_id = 'bc26f7d9-10d7-4013-9785-4a54fea85ce4'
        config.sh_client_secret = '.?;_{W5t9c>eJOGjDvaS;xmk5iaFH-K)v5j-vDD:'
        config.save()

...
def show_predict_page():
    ...
    if ok:
        ...
        #acount maria
        config.instance_id = 'b0e53057-f8c8-432a-9738-e504ca86609a'
        config.sh_client_id = '5521ef9d-5100-456a-88e5-f6922d891dba'
        config.sh_client_secret = '[C2c.8_5pA/>.^[0GH0{Q6G7+_KeOi{RRca>bE^c'
        config.save()

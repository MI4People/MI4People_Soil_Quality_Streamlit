...
def show_predict_page():
    ...
    if ok:
        ...
        #acount maria
        config.instance_id = '75ad9c4f-1004-45db-93b8-9597934a130d'
        config.sh_client_id = '7a53eea0-1673-4f09-905b-36ef830311eb'
        config.sh_client_secret = 'NPJ)lmg52w?m4amc1G]U1]6]gK9V}V9nD06l%pEA'
        config.save()

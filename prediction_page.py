...
def show_predict_page():
    ...
    if ok:
        ...
        #acount maria
        config.instance_id = 'ffa2fa2a-799c-401d-893d-dfd9bf100660'
        config.sh_client_id = '27901141-2048-44b5-9b97-6adef7504430'
        config.sh_client_secret = 'T}8)+7yXExie{g|U9ca0RmtXaBOb)YrLBRUgvd-I'
        config.save()

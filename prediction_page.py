...
def show_predict_page():
    ...
    if ok:
        ...
        #acount maria
        config.instance_id = '6bbc30f4-d596-402d-a59e-4573036a908d'
        config.sh_client_id = '2beeb37a-bbad-41a6-bbb2-a3b4b3b94840'
        config.sh_client_secret = '0G2qz1fccoI|x|;nJ4!{s*qjji0gIKEeDD{_+UL{'
        config.save()

...
def show_predict_page():
    ...
    if ok:
        ...
        #acount maria
        config.instance_id = 'c4884903-919e-4ce1-b4d6-c1ca85be75f0'
        config.sh_client_id = '84cb8851-568b-4672-a70d-48449ed9b93d'
        config.sh_client_secret = 'EDclx<yNPIjfopn]0y3&4?y([wI6qlNa7+by[2kD'
        config.save()

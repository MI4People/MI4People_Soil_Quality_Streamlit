...
def show_predict_page():
    ...
    if ok:
        ...
        #acount maria
        config.instance_id = '50cb092b-072e-41db-b63b-5b47399b17de'
        config.sh_client_id = '531fd58f-c45c-4da6-b3df-3537d01b3627'
        config.sh_client_secret = '676e4JX-N.]|R?qg&ci;BN*,PiaETZ@zSQIuCk+W'
        config.save()

...
def show_predict_page():
    ...
    if ok:
        ...
        #acount maria
        config.instance_id = '9d0d281f-2b31-4118-8cee-1bd3c3881d3c'
        config.sh_client_id = 'afda6368-6ef8-4f6a-a050-927197c6d8a6'
        config.sh_client_secret = 'GvA#H@{>couDa:KGWcheJcy!F-Rr{;DEc-w@cC1#'
        config.save()
